...
const Palette = ({
  ...
  const getBaseColor = (name: string,code: string) => {
    return fullData?.[name]?.[code];
  }
  return (
                    ...
                    {Object.entries(fullData?.[name] ?? {})
                      ...
                      .map((
                        ...
                        <div
                          ...
                          className={`group flex h-16 w-1/12 cursor-pointer items-center justify-center rounded-lg p-4 border-2`}
                        >
                          <div className="flex flex-col">
