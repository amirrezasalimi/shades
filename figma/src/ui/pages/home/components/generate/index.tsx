...
const GeneratePalette = () => {
  ...
  const [generateModalStatus, setGenerateModalStatus] = useState(false);
  ...
  return (
    <div>
      ...
      <div className="relative mx-6">
        <ColorPalette
          colorPaletteState={generateModalStatus}
          setColorPaletteState={setGenerateModalStatus}
